...
company:      Humanify
location:     China 🇨🇳
focus:        ["Agentic Workflow", "LLM Infra", "Distributed Systems"]
open_source:  ["Apache Seata-Go Committer", "AI Agent OSS Contributor"]
motto:        "Learning is a lifelong journey."
```

- 🔭 目前在做:**AI Agent / LLM 应用 & 基础设施**
- 🌱 长期投入:**Apache Seata-Go** —— 分布式事务的 Go 实现
- 💬 聊聊:Agent 架构、分布式事务、Go/Java 后端、面试经验
- 📫 联系我:xingyue@apache.org
...
### <img src="https://media.giphy.com/media/LnQjpWaON8nhr21vNW/giphy.gif" width="28"> 经历 / Experience

**🏢 工作经历 / Work**
- **AI Agent Engineer** @ `Humanify` · 负责 Agent 框架研发与落地

**🌍 开源经历 / Open Source**
- **Apache Committer** —— [Apache Seata-Go](https://github.com/apache/incubator-seata-go),负责分布式事务 Go 实现的核心模块
- **Maintainer** —— 多个 AI Agent 相关项目
- 长期贡献:Seata 社区、AI Agent 生态
...
<img src="https://github-profile-trophy.vercel.app/?username=Ethan-Xingyue&theme=tokyonight&no-frame=true&row=1&column=7&margin-w=8" />
...
[![Email](https://img.shields.io/badge/xingyue@apache.org-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:xingyue@apache.org)
[![GitHub](https://img.shields.io/badge/Ethan--Xingyue-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Ethan-Xingyue)
[![Apache](https://img.shields.io/badge/Apache_Committer-D22128?style=for-the-badge&logo=apache&logoColor=white)](https://github.com/apache/incubator-seata-go)

<br/>

![Profile Views](https://komarev.com/ghpvc/?username=Ethan-Xingyue&style=for-the-badge&color=58a6ff)
![Followers](https://img.shields.io/github/followers/Ethan-Xingyue?style=for-the-badge&color=58a6ff)
...
<sub>⭐️ From <a href="https://github.com/Ethan-Xingyue">Ethan-Xingyue</a> · Inspired by the OSS community ❤️</sub>
